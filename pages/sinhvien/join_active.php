...
<div class="mb-3 w-50 float-right">
  <form action="" method="POST">
    <div class="input-group">
      <input type="text" class="form-control form-control" placeholder="Tìm kiếm" name="input-search" value="<?php echo isset($_POST['input-search']) ? $_POST['input-search'] : '' ?>" required />
