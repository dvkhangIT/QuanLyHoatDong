      ...
      <div class="d-flex align-items-center justify-content-around">
        <div class="custom-control custom-radio">
          <div class="d-flex align-items-center">
            <input class="custom-control-input" type="radio" name="radio_option" id="sinh_vien" checked="" value="sinhvien" />
        ...
        <div class="custom-control custom-radio">
          <div class="d-flex align-items-center">
            <input class="custom-control-input" type="radio" name="radio_option" id="quan_ly" value="admin" />
