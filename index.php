        ...
        <nav class="background-pr d-flex">
          ...
          <div class="col-2 d-flex flex-nowrap">
            <div class="user py-2 d-block">
              <div class="">
                <button class="dropdown-toggle bg-transparent border-0 text-white" type="" data-toggle="dropdown" aria-expanded="false">
                ...
                <div class="dropdown-menu">
                  <a class='dropdown-item <?php echo isset($_SESSION['tenDangNhap']) ? "" : "disabled" ?>' data-toggle="modal" data-target="#staticBackdrop" href="#">Thông tin
                    cá nhân</a>
                  <a class="dropdown-item <?php echo isset($_SESSION['tenDangNhap']) ? "" : "disabled" ?>" href="?url=changepassword">Đổi mật khẩu</a>
