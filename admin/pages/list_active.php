    ...
    <div class="mb-3 w-50 float-right">
        <form action="" method="POST">
            <div class="input-group">
                <input type="text" class="form-control form-control" placeholder="Nhập tên hoạt động....?" name="input-search" />
    ...
    <tbody>
        ...
        ?>
                <tr>
                    ...
                    <td>
                        <a href="?url=edit_active&id=<?php echo $row['hoatDongID'] ?>" class="btn btn-outline-primary">Sửa</a>
                    </td>
                    <td>
                        <a href="?url=delete_active&id=<?php echo $row['hoatDongID'] ?>" class="btn btn-outline-danger">Xoá</a>
                    </td>
                </tr>
        <?php
            }
            ...
            echo "<script>window.location.href=index.php?url=error</script>";
        }
        ?>
    </tbody>
</table>
