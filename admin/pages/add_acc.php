    ...
    <div class="row">
        ...
        <div class="col-6">
            ...
            <form class="form-group" method="post" enctype="multipart/form-data">
                <div class="mb-4 mt-4">
                    <label for="MSSV" class="form-label">Tên đăng nhập</label>
                ...
                <input type="hidden" name="vaiTro" class="form-control" id="vaiTro" value="sinhvien" required />
